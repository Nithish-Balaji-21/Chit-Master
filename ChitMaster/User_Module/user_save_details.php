...
$conn= mysqli_connect("sql211.infinityfree.com","if0_39630032","Nithish21","if0_39630032_chitmaster") or die("Connection Failed");
    ...
    $stmt_users->bind_param("ssssssssssiiissss", $name, $userstatus, $dob, $aadhar, $address, $email, $usergender, $phone, $occupation, $retirement_year, $family_count, $account_no, $num, $savings, $useremi, $username, $password);
